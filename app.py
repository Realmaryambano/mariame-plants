...
PRODUCTS = [
    ...
    {
        "id": 7,
        "name": "Bougainvillea Bonsai Specimen",
        "category": "outdoor",
        "badge": "Vibrant",
        "price": 4100,
        "rating": 4.7,
    ...
    {
        "id": 15,
        "name": "Pachycereus Candelabra Cactus",
        "category": "cactus",
        "badge": "Statement",
        "price": 5500,
        "rating": 4.9,
    ...
    {
        "id": 20,
        "name": "Mariamé Premium Aroid Soil Mix (5kg)",
        "category": "soil",
        "badge": "Best Grade",
        "price": 1600,
        "rating": 5.0,
        "desc": "Custom coarse blend of chunky orchid bark, perlite, horticultural charcoal, and organic peat.",
        "image": "mariame-premium-aroid-soil-mix.png",
    },
    {
        "id": 21,
        "name": "Cactus & Succulent Grit Blend (3kg)",
        "category": "soil",
        "badge": "Fast Draining",
        "price": 1200,
        "rating": 4.8,
        "desc": "Mineral-heavy fast draining substrate formula engineered to completely prevent root rot.",
        "image": "cactus-succulent-grit-blend.png",
    },
    {
        "id": 22,
        "name": "Nutrient-Dense Organic Worm Castings",
        "category": "soil",
        "badge": "Bio-Active",
        "price": 950,
        "rating": 4.9,
    ...
    {
        "id": 23,
        "name": "Expanded Perlite & Pumice Aeration Pack",
        "category": "soil",
        "badge": "Essential",
        "price": 850,
        "rating": 4.7,
        "desc": "Lightweight volcanic rock additives designed to maximize oxygen flow inside heavy soils.",
        "image": "expanded-perlite-pumice-aeration.png",
    },
    {
        "id": 24,
        "name": "Handmade Terracotta Cylinder Pot",
        "category": "pots",
        "badge": "Handmade",
        "price": 1800,
        "rating": 4.8,
    ...
    {
        "id": 25,
        "name": "Minimalist Matte Ceramic Planter",
        "category": "pots",
        "badge": "Modern",
        "price": 2400,
        "rating": 4.9,
    ...
    {
        "id": 26,
        "name": "Woven Natural Seagrass Basket Pot",
        "category": "pots",
        "badge": "Boho Style",
        "price": 2100,
        "rating": 4.7,
        "desc": "Hand-woven organic seagrass basket equipped with a protective inner plastic moisture liner.",
        "image": "woven-natural-seagrass-basket.png",
    },
    {
        "id": 27,
        "name": "Nordic Concrete Textured Cachepot",
        "category": "pots",
        "badge": "Industrial",
        "price": 2900,
        "rating": 4.8,
    ...
    {
        "id": 28,
        "name": "Glazed Japanese Bonsai Training Tray",
        "category": "pots",
        "badge": "Specialty",
        "price": 3500,
        "rating": 4.9,
